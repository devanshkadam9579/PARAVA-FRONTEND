...
center_nav = '''        {/* Center Navigation / Animated Search Capsule */}
        <div className="hidden md:flex flex-1 items-center justify-center relative">
          <div 
            className={bsolute transition-all duration-300 ease-in-out }
          >
          ...
          <div 
            className={bsolute transition-all duration-300 ease-in-out cursor-pointer  flex items-center justify-center}
